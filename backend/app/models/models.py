...
# CREATE TABLE "BookingsEquipments" (
#   "id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
#   "deleted" boolean DEFAULT false
# );
class BookingsEquipments(Base):
    __tablename__ = "BookingsEquipments"
    ...
    bookings = relationship('Bookings', backref='bookings_equipments')
    equipments = relationship('Equipments', backref='bookings_equipments')
# CREATE TABLE "BookingsAccessibilities" (
#   "id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
#   "booking_id" int NOT NULL,
#   "accessibility_id" int NOT NULL,
#   "created_at" timestamp DEFAULT (now()),
#   "deleted" boolean DEFAULT false
# );
class BookingsAccessibilities(Base):
    __tablename__ = "BookingsAccessibilities"
    ...
    bookings = relationship('Bookings', backref='bookings_accessibilities')
    accessibilities = relationship('Accessibilities', backref='bookings_accessibilities')
# CREATE TABLE "BookingsFacilities" (
#   "id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
#   "booking_id" int NOT NULL,
#   "facility_id" int NOT NULL,
#   "created_at" timestamp DEFAULT (now()),
#   "deleted" boolean DEFAULT false
# );
class BookingsFacilities(Base):
    __tablename__ = "BookingsFacilities"
    ...
    bookings = relationship('Bookings', backref='bookings_facilities')
    facilities = relationship('Facilities', backref='booking_facilities')
